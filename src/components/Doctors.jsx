        ...
        <div className="flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
          <div>
            ...
            <p className="mt-2 text-center lg:text-start">
              ...
              providing expert medical care across various specialties. Each of our physicians
              brings years of experience, advanced knowledge, and a deep commitment to your
